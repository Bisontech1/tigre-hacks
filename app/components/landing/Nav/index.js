      ...
      <div className="nav">
        ...
        <div className="nav-header">
          <div className="nav-title">
            <img
              src="logo.png"
              alt="Little logo of Tigre Hacks in a Nav Bar in the top left corner of the page"
            />
          </div>
        </div>
        ...
        <div className="nav-links">
          ...
          <a href="#" className="text-link">
            {language?.getString("navbar.whyParticipate") ?? "¿Por qué participar?"}
          </a>
          <a href="#" className="text-link">
          ...
          <a href="https://www.instagram.com/bisontech_/" aria-label="Instagram Icon" className="icon">
            <svg
          ...
          <a href="https://www.facebook.com/bisontech1" className="icon" aria-label="Facebook Icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              data-name="Layer 1"
              viewBox="0 0 24 24"
          ...
          <a href="https://github.com/Bisontech1" className="icon" aria-label="Github Icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              data-name="Layer 1"
              viewBox="0 0 24 24"
...
const LanguageDropdown = (props) => {
  const languages = Language.array?.map((e) => (
    <li
      ...
      className="lang-item"
    >
      <img src={`flags/${e.id}.svg`} alt={e.name} />
      {e.name}
    </li>
  ));
  ...
  return (
    <div className="dropdown">
      <img src={`flags/${props.language?.id ?? 'es'}.svg`} alt={props.language?.name} />
