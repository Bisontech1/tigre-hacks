"use client";
import { Box, Typography, TextField, Button, Card, CardHeader, CardContent, Grid } from '@mui/material'
                                ...
                                <Grid item>
                                    <Card sx={{ m: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h5">{team[1].team_name}</Typography>
                                            {team[1].members ?
                                                ...
                                                :
                                                <Typography variant="subtitle1">No Hay miembros aún</Typography>}</CardContent>
                                    </Card>
                                </Grid>
                            )
                        })
